  ...
  <div class="entity-pilotage">
    ...
    <div v-else>
      ...
      <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
          <h5 class="mb-1">Pilotage stratégique et contrôle</h5>
          <p class="text-muted mb-0">
            Gérez les outils de pilotage stratégique et de contrôle de gestion
          </p>
        </div>
        ...
        <div class="col-md-6">
          <div class="input-group">
            ...
            <input 
              ...
              type="text" 
              class="form-control" 
              placeholder="Rechercher un outil de pilotage...">
          </div>
        </div>
        <div class="col-md-3">
          ...
          <div class="card-header bg-light">
            <div class="d-flex justify-content-between align-items-center">
              <h6 class="mb-0">
                ...
                Pilotage stratégique et contrôle
      ...
      <div v-else class="text-center py-5">
        ...
        <h6 class="text-muted">Aucun outil de pilotage</h6>
        <p class="text-muted mb-4">
          {{ searchTerm || statusFilter ? 'Aucun outil ne correspond à vos critères de recherche.' : 'Cette entité n\'a pas encore d\'outils de pilotage assignés.' }}
        </p>
        <button v-if="!searchTerm && !statusFilter" @click="initializeTools" class="btn btn-success">
          <i class="fas fa-plus me-2"></i>
          Initialiser les outils de pilotage
        </button>
      </div>
    </div>
  ...
  setup(props) {
    ...
    const stats = computed(() => {
      const filteredByCategory = tools.value.filter(tool => 
        tool.category === 'Pilotage stratégique et contrôle'
      )
    ...
    const filteredTools = computed(() => {
      ...
      return tools.value.filter(tool => {
        // Ne garder que les outils de la catégorie "Pilotage stratégique et contrôle"
        if (tool.category !== 'Pilotage stratégique et contrôle') {
          return false
        }
    ...
    const loadData = async () => {
      ...
      try {
        ...
        notifyError('Erreur lors du chargement des outils de pilotage')
      } finally {
        loading.value = false
      }
    }
    ...
    const initializeTools = async () => {
      try {
        ...
        await loadData()
        notifySuccess('Outils de pilotage initialisés avec succès')
      } catch (error) {
    ...
    const exportToExcel = async () => {
      try {
        await store.dispatch('outils/exportToExcel', {
          entityId: props.entityId,
          category: 'Pilotage stratégique et contrôle'
        })
